...
class Notification(models.Model):
    ...
    _LIKED_TEMPLATE = u'<a href="/profile/{0}/">{1}</a> liked your post: <a href="/feeds/{2}/">{3}</a>'
    _COMMENTED_TEMPLATE = u'<a href="/profile/{0}/">{1}</a> commented on your post: <a href="/feeds/{2}/">{3}</a>'
    _FAVORITED_TEMPLATE = u'<a href="/profile/{0}/">{1}</a> favorited your question: <a href="/questions/{2}/">{3}</a>'
    _ANSWERED_TEMPLATE = u'<a href="/profile/{0}/">{1}</a> answered your question: <a href="/questions/{2}/">{3}</a>'
    _ACCEPTED_ANSWER_TEMPLATE = u'<a href="/profile/{0}/">{1}</a> accepted your answer: <a href="/questions/{2}/">{3}</a>'
    _EDITED_ARTICLE_TEMPLATE = u'<a href="/profile/{0}/">{1}</a> edited your article: <a href="/article/{2}/">{3}</a>'
    _ALSO_COMMENTED_TEMPLATE = u'<a href="/profile/{0}/">{1}</a> also commentend on the post: <a href="/feeds/{2}/">{3}</a>'
